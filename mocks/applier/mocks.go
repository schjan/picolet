...
//   - ctx context.Context
//   - name string
func (_e *MockSystemdManager_Expecter) DisableUnit(ctx interface{}, name interface{}) *MockSystemdManager_DisableUnit_Call {
...
//   - ctx context.Context
//   - name string
func (_e *MockSystemdManager_Expecter) EnableUnit(ctx interface{}, name interface{}) *MockSystemdManager_EnableUnit_Call {
...
// UnitState provides a mock function for the type MockSystemdManager
func (_mock *MockSystemdManager) UnitState(ctx context.Context, name string) (string, error) {
	ret := _mock.Called(ctx, name)

	if len(ret) == 0 {
		panic("no return value specified for UnitState")
	}
...
// MockSystemdManager_UnitState_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UnitState'
type MockSystemdManager_UnitState_Call struct {
	*mock.Call
}

// UnitState is a helper method to define mock.On call
//   - ctx context.Context
//   - name string
func (_e *MockSystemdManager_Expecter) UnitState(ctx interface{}, name interface{}) *MockSystemdManager_UnitState_Call {
	return &MockSystemdManager_UnitState_Call{Call: _e.mock.On("UnitState", ctx, name)}
}

func (_c *MockSystemdManager_UnitState_Call) Run(run func(ctx context.Context, name string)) *MockSystemdManager_UnitState_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockSystemdManager_UnitState_Call) Return(s string, err error) *MockSystemdManager_UnitState_Call {
	_c.Call.Return(s, err)
	return _c
}

func (_c *MockSystemdManager_UnitState_Call) RunAndReturn(run func(ctx context.Context, name string) (string, error)) *MockSystemdManager_UnitState_Call {
	_c.Call.Return(run)
	return _c
}
